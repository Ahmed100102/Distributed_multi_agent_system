...
app = FastAPI(title="ObservabilityAnalyst Chatbot", description="API for log analytics and system observability")
...
MODEL_RUNTIME = os.getenv("MODEL_RUNTIME", "llama_cpp").lower()
